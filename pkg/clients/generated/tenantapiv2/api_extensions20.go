...
// Filters the resulting set of Java processes by the ID of the host they run on, in the form &#39;HOST-XXXXXXXXXXXXXXXX&#39;. The exact match is required.
func (r ApiGetJmxProcessRequest) HostId(hostId string) ApiGetJmxProcessRequest {
	r.hostId = &hostId
	return r
}

func (r ApiGetJmxProcessRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.GetJmxProcessExecute(r)
}

/*
GetJmxProcess Retrieves details of a specified Java process discovered in the environment for JMX metric collection.
...
func (a *Extensions20APIService) GetJmxProcessExecute(r ApiGetJmxProcessRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.hostId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hostId", r.hostId, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiGetPmiProcessRequest struct {
	ctx context.Context
	ApiService *Extensions20APIService
	processId string
	hostId *string
...
// Filters the resulting set of Java processes by the ID of the host they run on, in the form &#39;HOST-XXXXXXXXXXXXXXXX&#39;. The exact match is required.
func (r ApiGetPmiProcessRequest) HostId(hostId string) ApiGetPmiProcessRequest {
	r.hostId = &hostId
	return r
}

func (r ApiGetPmiProcessRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.GetPmiProcessExecute(r)
}

/*
GetPmiProcess Retrieves details of a specified Java process discovered in the environment for PMI metric collection.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param processId Id of the Java process discovered in the environment.
 @return ApiGetPmiProcessRequest
*/
func (a *Extensions20APIService) GetPmiProcess(ctx context.Context, processId string) ApiGetPmiProcessRequest {
	return ApiGetPmiProcessRequest{
		ApiService: a,
		ctx: ctx,
		processId: processId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *Extensions20APIService) GetPmiProcessExecute(r ApiGetPmiProcessRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Extensions20APIService.GetPmiProcess")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/extensions/discovery/pmi/processes/{process-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"process-id"+"}", url.PathEscape(parameterValueToString(r.processId, "processId")), -1)
...
// Filters the resulting set of Java processes by the ID of the host they run on, in the form &#39;HOST-XXXXXXXXXXXXXXXX&#39;. The exact match is required.
func (r ApiListJmxProcessesRequest) HostId(hostId string) ApiListJmxProcessesRequest {
	r.hostId = &hostId
	return r
}
...
type ApiListPmiProcessesRequest struct {
	ctx context.Context
	ApiService *Extensions20APIService
	hostId *string
}
...
// Filters the resulting set of Java processes by the ID of the host they run on, in the form &#39;HOST-XXXXXXXXXXXXXXXX&#39;. The exact match is required.
func (r ApiListPmiProcessesRequest) HostId(hostId string) ApiListPmiProcessesRequest {
	r.hostId = &hostId
	return r
}

func (r ApiListPmiProcessesRequest) Execute() ([]JavaProcessContainerList, *http.Response, error) {
	return r.ApiService.ListPmiProcessesExecute(r)
}

/*
ListPmiProcesses Lists all Java processes discovered in the environment that are available for PMI metric collection.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListPmiProcessesRequest
*/
func (a *Extensions20APIService) ListPmiProcesses(ctx context.Context) ApiListPmiProcessesRequest {
	return ApiListPmiProcessesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []JavaProcessContainerList
func (a *Extensions20APIService) ListPmiProcessesExecute(r ApiListPmiProcessesRequest) ([]JavaProcessContainerList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Extensions20APIService.ListPmiProcesses")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/extensions/discovery/pmi/processes"
